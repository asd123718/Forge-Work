...
import { Tunnel, TunnelEndpoint, TunnelPort, ClusterDetails, ClusterRecommendationResponse, NamedRateStatus, TunnelReportProgressEventArgs, TunnelEvent } from '@microsoft/dev-tunnels-contracts';
...
export declare class TunnelManagementHttpClient implements TunnelManagementClient {
    ...
    private readonly isCustomDomain;
     ...
     */
    enableEventsReporting: boolean;
    private readonly eventsQueue;
    private eventsPromise;
    private isDisposed;
    private eventsAvailableCompletion;
    /**
     ...
     */
    static forCustomDomain(customDomain: string, userAgents: (ProductHeaderValue | string)[] | ProductHeaderValue | string, apiVersion: ManagementApiVersions, userTokenCallback?: () => Promise<string | null>, httpsAgent?: https.Agent, adapter?: AxiosAdapter): TunnelManagementHttpClient;
    ...
    getClusterRecommendations(preferredClusterId?: string, requiredGeo?: string, cancellation?: CancellationToken): Promise<ClusterRecommendationResponse>;
    /**
    ...
    private processPendingEventsAsync;
