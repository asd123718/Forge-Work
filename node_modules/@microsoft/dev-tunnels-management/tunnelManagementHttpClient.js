...
class TunnelManagementHttpClient {
    ...
    async createTunnel(tunnel, options, cancellation) {
        ...
        if (!tunnel.clusterId) {
            try {
                const recommendations = await this.getClusterRecommendations(undefined, options.requiredGeo, cancellation);
                if (recommendations === null || recommendations === void 0 ? void 0 : recommendations.recommendedClusterId) {
    ...
    async getClusterRecommendations(preferredClusterId, requiredGeo, cancellation) {
        const queryParts = [];
        ...
        return (await this.sendRequest('GET', undefined, clustersApiPath + recommendationsSubPath, query, undefined, undefined, false, cancellation));
    }
    /**
