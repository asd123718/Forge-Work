...
export declare namespace TunnelConstraints {
     ...
     */
    const eventDetailsMaxLength: number;
    /**
     * Max number of properties in a tunnel event.
     */
    const maxEventProperties: number;
    /**
     * Max length of a single tunnel event property value.
     */
    const eventPropertyValueMaxLength: number;
    /**
     ...
     * Cluster IDs are alphanumeric; hyphens are not permitted.
     */
    const clusterIdPrefixRegex: RegExp;
    /**
