...
export interface TunnelRelayStreamFactory {
     ...
     */
    createRelayStream(relayUri: string, protocols: string[], accessToken?: string, clientConfig?: IClientConfig): Promise<{
        stream: Stream;
        protocol: string;
    }>;
}
//# sourceMappingURL=tunnelRelayStreamFactory.d.ts.map