...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('pr.show', async (pr) => {
    ...
    async function updateItem(afterAway) {
        ...
        const data = await (0, graphql_1.graphql)(query, { headers: { authorization: `Bearer ${currentSession.accessToken}` } });
