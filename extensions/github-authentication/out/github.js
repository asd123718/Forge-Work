...
exports.needsAccountIconLookup = needsAccountIconLookup;
exports.serializeAccountIcon = serializeAccountIcon;
 ...
 */
function needsAccountIconLookup(session) {
 ...
 */
function serializeAccountIcon(icon, hasNoAvatar) {
    if (icon) {
...
class GitHubAuthenticationProvider {
    ...
    _sessionsWithoutAvatars = new WeakSet();
    _disposable;
    _sessionsPromise;
