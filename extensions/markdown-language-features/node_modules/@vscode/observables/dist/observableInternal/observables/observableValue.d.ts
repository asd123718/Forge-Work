 ...
 */
export declare function observableValue<T, TChange = void>(name: string, initialValue: T, debugLocation?: DebugLocation): ISettableObservable<T, TChange>;
export declare function observableValue<T, TChange = void>(owner: object, initialValue: T, debugLocation?: DebugLocation): ISettableObservable<T, TChange>;
