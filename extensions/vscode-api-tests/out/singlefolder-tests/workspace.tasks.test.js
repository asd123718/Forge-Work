        ...
        suite('CustomExecution', () => {
            ...
            test('A task can be fetched and executed (#100577)', async () => {
                class CustomTerminal {
                    writeEmitter = new vscode_1.EventEmitter();
                    onDidWrite = this.writeEmitter.event;
                    async close() { }
                    closeEmitter = new vscode_1.EventEmitter();
                    onDidClose = this.closeEmitter.event;
                    _onDidOpen = new vscode_1.EventEmitter();
            ...
            test('Tasks can be run back to back', async () => {
                class Pty {
                    num;
                    quick;
                    writer = new vscode_1.EventEmitter();
                    onDidWrite = this.writer.event;
                    closer = new vscode_1.EventEmitter();
