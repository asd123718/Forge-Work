...
(vscode.env.uiKind === vscode.UIKind.Web ? suite.skip : suite)('Interactive Window', function () {
    ...
    test.skip('Interactive window has the correct kernel', async function () {
        ...
        await (0, utils_1.poll)(() => Promise.resolve(secondKernel.associatedNotebooks.has(notebookEditor.notebook.uri.toString())), v => v, 'Secondary kernel was not set as the kernel for the interactive window');
