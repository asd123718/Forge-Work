    ...
    suite('Terminal', () => {
        ...
        (process.platform === 'win32' ? suite.skip : suite)('environmentVariableCollection', () => {
            ...
            test('get and forEach should work', () => {
                ...
                (0, assert_1.deepStrictEqual)(collection.get('A'), { value: '~a2~', type: vscode_1.EnvironmentVariableMutatorType.Replace, options: defaultOptions, variable: 'A' });
                (0, assert_1.deepStrictEqual)(collection.get('B'), { value: '~b2~', type: vscode_1.EnvironmentVariableMutatorType.Append, options: defaultOptions, variable: 'B' });
                (0, assert_1.deepStrictEqual)(collection.get('C'), { value: '~c2~', type: vscode_1.EnvironmentVariableMutatorType.Prepend, options: defaultOptions, variable: 'C' });
                // Verify forEach
                const entries = [];
                collection.forEach((v, m) => entries.push([v, m]));
                (0, assert_1.deepStrictEqual)(entries, [
                    ['A', { value: '~a2~', type: vscode_1.EnvironmentVariableMutatorType.Replace, options: defaultOptions, variable: 'A' }],
                    ['B', { value: '~b2~', type: vscode_1.EnvironmentVariableMutatorType.Append, options: defaultOptions, variable: 'B' }],
                    ['C', { value: '~c2~', type: vscode_1.EnvironmentVariableMutatorType.Prepend, options: defaultOptions, variable: 'C' }]
                ]);
            });
            test('get and forEach should work (scope)', () => {
                ...
                (0, assert_1.deepStrictEqual)(expectedScopedCollection.get('A'), { value: 'scoped~a2~', type: vscode_1.EnvironmentVariableMutatorType.Replace, options: defaultOptions, variable: 'A' });
                (0, assert_1.deepStrictEqual)(expectedScopedCollection.get('B'), { value: 'scoped~b2~', type: vscode_1.EnvironmentVariableMutatorType.Append, options: defaultOptions, variable: 'B' });
                (0, assert_1.deepStrictEqual)(expectedScopedCollection.get('C'), { value: 'scoped~c2~', type: vscode_1.EnvironmentVariableMutatorType.Prepend, options: defaultOptions, variable: 'C' });
                // Verify forEach
                const entries = [];
                expectedScopedCollection.forEach((v, m) => entries.push([v, m]));
                (0, assert_1.deepStrictEqual)(entries.map(v => v[1]), [
                    { value: 'scoped~a2~', type: vscode_1.EnvironmentVariableMutatorType.Replace, options: defaultOptions, variable: 'A' },
                    { value: 'scoped~b2~', type: vscode_1.EnvironmentVariableMutatorType.Append, options: defaultOptions, variable: 'B' },
                    { value: 'scoped~c2~', type: vscode_1.EnvironmentVariableMutatorType.Prepend, options: defaultOptions, variable: 'C' }
                ]);
