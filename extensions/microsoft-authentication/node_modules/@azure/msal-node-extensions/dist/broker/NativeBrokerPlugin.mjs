/*! @azure/msal-node-extensions v5.3.2 2026-07-07 */
'use strict';
...
class NativeBrokerPlugin {
    ...
    wrapError(error, correlationId) {
        if (error &&
            ...
            const msalNodeRuntimeError = new PlatformBrokerError(ErrorStatus[errorStatus], correlationId, errorContext, errorCode, errorTag);
            let wrappedError;
            switch (errorStatus) {
