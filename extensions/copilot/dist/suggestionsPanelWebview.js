...
(() => {
  ...
  var prependToAdoptedStyleSheetsSymbol = /* @__PURE__ */ Symbol("prependToAdoptedStyleSheets");
...
`;
  ...
  function createSolutionElements(solution, index) {
    ...
    const elements = [heading, snippetContainer];
    const citation = solution.citation ? createCitationElement(solution.citation) : void 0;
    if (citation) {
  ...
  function setSnippetHtml(element, html2) {
    const sanitizerElement = element;
    sanitizerElement.setHTML(html2, { sanitizer: getSnippetSanitizer() });
  }
  var snippetSanitizer;
  function getSnippetSanitizer() {
  ...
  function getTrustedCitationUrl(url) {
    try {
      const parsedUrl = new URL(url);
      return parsedUrl.protocol === "https:" ? parsedUrl.href : void 0;
    } catch {
      return void 0;
    }
  }
