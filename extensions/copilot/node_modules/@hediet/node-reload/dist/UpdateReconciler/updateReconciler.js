...
exports.hotCallExportedFunction = exports.hotRequireExportedFn = exports.disposeOnReload = exports.getReloadCount = exports.registerUpdateReconciler = void 0;
const utils_1 = require("../utils");
const utils_2 = require("../utils");
const Reconciler_1 = require("../Reconciler");
const HotReloadService_1 = require("../HotReloadService");
const moduleInfoProperty = new utils_2.AttachedProperty(() => undefined);
/**
...
function registerUpdateReconciler(module) {
    ...
    Reconciler_1.setModuleReconciler(module, context => {
        ...
        utils_1.dispose(info.disposables);
        ...
        for (const updater of curUpdaters) {
            ...
            try {
                utils_1.dispose(updater.lastDisposable);
            }
            catch (e) {
...
function disposeOnReload(module, disposable) {
    ...
    info.disposables.push(...utils_1.Disposable.normalize(disposable));
}
...
function hotRequireExportedFn(module, exportedFn, updateOrOptions, optionalUpdate) {
    ...
    */
    ...
    return utils_1.Disposable.create(() => {
