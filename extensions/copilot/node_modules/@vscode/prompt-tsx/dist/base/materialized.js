...
exports.BudgetExceededError = exports.MaterializedChatMessageDocument = exports.MaterializedChatMessageImage = exports.MaterializedChatMessageBreakpoint = exports.MaterializedChatMessageOpaque = exports.MaterializedChatMessage = exports.MaterializedChatMessageTextChunk = exports.GenericMaterializedContainer = void 0;
...
class MaterializedChatMessage {
    ...
    baseMessageTokenCount = (0, once_1.once)((tokenizer) => {
        ...
        raw.content = raw.content
            ...
            else if (message.type === mode_1.Raw.ChatCompletionContentPartKind.Document) {
                return undefined;
            }
            else {
                return message;
    ...
    toChatMessage() {
        const content = this.text.map((element) => {
            if (typeof element === 'string') {
                ...
                return {
                    type: mode_1.Raw.ChatCompletionContentPartKind.Document,
                    documentData: {
                        data: element.data,
...
class MaterializedChatMessageImage {
    ...
    detail;
    mimeType;
    constructor(parent, id, src, priority, metadata = [], lineBreakBefore, detail, mimeType) {
        this.parent = parent;
        this.id = id;
        this.src = src;
        this.priority = priority;
...
class MaterializedChatMessageDocument {
    parent;
    id;
    data;
    mediaType;
    ...
    metadata;
    lineBreakBefore;
    constructor(parent, id, data, mediaType, priority, metadata = [], lineBreakBefore) {
        this.parent = parent;
        this.id = id;
        this.data = data;
...
exports.MaterializedChatMessageDocument = MaterializedChatMessageDocument;
