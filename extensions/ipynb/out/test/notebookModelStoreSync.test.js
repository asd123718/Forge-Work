...
suite(`Notebook Model Store Sync`, () => {
    ...
    setup(() => {
        ...
        const stub = sinon.stub(vscode_1.NotebookEdit, 'updateCellMetadata').callsFake((index, metadata) => {
            const edit = stub.wrappedMethod.call(vscode_1.NotebookEdit, index, metadata);
