...
class TypeScriptServiceClient extends dispose_1.Disposable {
    ...
    startService(resendModels = false) {
        ...
        */
        ...
        handle.onEvent((0, generation_1.createGenerationGuardedHandler)(mytoken, () => this.token, () => !this.isDisposed && this.serverState.type === 1 /* ServerState.Type.Running */ && this.serverState.server === handle, event => this.dispatchEvent(event)));
