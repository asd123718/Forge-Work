...
export async function isUniversalMacho(file) {
    let filehandle, buf;
    try {
...
export const mergeASARs = async ({ x64AsarPath, arm64AsarPath, outputAsarPath, singleArchFiles, filesToSkipComparison, }) => {
