...
exports.mergeASARs = exports.isUniversalMacho = exports.generateAsarIntegrity = exports.detectAsarMode = exports.AsarMode = void 0;
...
const detectAsarMode = async (appPath, asarPath) => {
    ...
    const result = asarPath
        ? path_1.default.resolve(appPath, asarPath)
        : path_1.default.resolve(appPath, 'Contents', 'Resources', 'app.asar');
    if (!(await fs_extra_1.default.pathExists(result))) {
...
async function isUniversalMacho(file) {
    let filehandle, buf;
    try {
...
const mergeASARs = async ({ x64AsarPath, arm64AsarPath, outputAsarPath, singleArchFiles, filesToSkipComparison, }) => {
